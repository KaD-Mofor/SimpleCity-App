...
/***/ "./src/plugins/OktaPluginDebugger/console.ts":
/*!***************************************************!*\
  !*** ./src/plugins/OktaPluginDebugger/console.ts ***!
  \***************************************************/
...
exports.setOnNewMessage = exports.restoreConsole = exports.removeGlobalErrorListeners = exports.overrideConsole = exports.callConsole = exports.addGlobalErrorListeners = void 0;
/*!
...
const consoleMethodsToOverride = ['assert', 'debug', 'dir', 'error', 'group', 'groupCollapsed', 'groupEnd', 'info', 'log', 'table', 'warn'];
let origConsole;
let onNewMessage;
...
exports.addGlobalErrorListeners = addGlobalErrorListeners;
const removeGlobalErrorListeners = () => {
  window.removeEventListener('unhandledrejection', onUnhandledRejection);
  window.removeEventListener('error', onGlobalError);
};
exports.removeGlobalErrorListeners = removeGlobalErrorListeners;
...
const callConsole = (method, ...args) => {
  var _window$console$metho;
  (_window$console$metho = window.console[method]) === null || _window$console$metho === void 0 ? void 0 : _window$console$metho.call(window.console, ...args);
};
exports.callConsole = callConsole;
const setOnNewMessage = newCallback => {
  onNewMessage = newCallback;
};
exports.setOnNewMessage = setOnNewMessage;
const overrideConsole = () => {
  origConsole = {};
  for (const method of consoleMethodsToOverride) {
    origConsole[method] = window.console[method];
    window.console[method] = (...args) => {
      var _onNewMessage;
      try {
        var _origConsole, _origConsole$method;
        (_origConsole = origConsole) === null || _origConsole === void 0 ? void 0 : (_origConsole$method = _origConsole[method]) === null || _origConsole$method === void 0 ? void 0 : _origConsole$method.call(window.console, ...args);
      } catch (_e) {
      ...
      (_onNewMessage = onNewMessage) === null || _onNewMessage === void 0 ? void 0 : _onNewMessage(msg);
    };
  }
};
...
const restoreConsole = () => {
  if (origConsole) {
    for (const method of consoleMethodsToOverride) {
      window.console[method] = origConsole[method];
    }
...
/***/ "./src/plugins/OktaPluginDebugger/fetch.ts":
/*!*************************************************!*\
  !*** ./src/plugins/OktaPluginDebugger/fetch.ts ***!
  \*************************************************/
/***/ (function(__unused_webpack_module, exports) {
...
exports.setOnNewFetch = exports.restoreFetch = exports.overrideFetch = void 0;
/*!
 * Copyright (c) 2015-2016, Okta, Inc. and/or its affiliates. All rights reserved.
 * The Okta software accompanied by this notice is provided pursuant to the Apache License, Version 2.0 (the "License.")
 *
...
const getRequestBody = init => {
  var _body$toString;
  const body = init === null || init === void 0 ? void 0 : init.body;
  if (!body) {
    return undefined;
  }
  if (typeof (body === null || body === void 0 ? void 0 : body.forEach) === 'function') {
    // URLSearchParams or FormData
    const data = {};
    body === null || body === void 0 ? void 0 : body.forEach((v, k) => {
      if (typeof v === 'string') {
        data[k] = v;
      }
    });
  ...
  return (body === null || body === void 0 ? void 0 : (_body$toString = body.toString) === null || _body$toString === void 0 ? void 0 : _body$toString.call(body)) ?? body;
};
const setOnNewFetch = newCallback => {
  onNewFetch = newCallback;
};
exports.setOnNewFetch = setOnNewFetch;
const overrideFetch = () => {
  ...
  window.fetch = async (input, init) => {
    ...
    try {
      ...
      const reqHeaders = readHeaders(init === null || init === void 0 ? void 0 : init.headers);
      delete reqMeta.body;
      ...
      (_onNewFetch = onNewFetch) === null || _onNewFetch === void 0 ? void 0 : _onNewFetch(fetchData);
      return resp;
    } catch (err) {
      var _onNewFetch2;
      fetchData.err = err;
      (_onNewFetch2 = onNewFetch) === null || _onNewFetch2 === void 0 ? void 0 : _onNewFetch2(fetchData);
      throw err;
    }
  };
};
...
/***/ "./src/plugins/OktaPluginDebugger/messages.ts":
/*!****************************************************!*\
  !*** ./src/plugins/OktaPluginDebugger/messages.ts ***!
  \****************************************************/
...
exports.serializeMessages = exports.serializeArgs = exports.getMessages = exports.fetchDataToMessage = exports.clearMessages = exports.addMessage = void 0;
var _utils = __webpack_require__(/*! ./utils */ "./src/plugins/OktaPluginDebugger/utils.ts");
/*!
 * Copyright (c) 2015-2016, Okta, Inc. and/or its affiliates. All rights reserved.
 * The Okta software accompanied by this notice is provided pursuant to the Apache License, Version 2.0 (the "License.")
 *
...
const addMessage = msg => {
  msg.time = (0, _utils.getCurrentTimeStamp)();
  messages.push(msg);
};
...
const fetchDataToMessage = fetchData => {
...
exports.fetchDataToMessage = fetchDataToMessage;
const serializeArgs = args => {
  return args
  // Concat strings
  .reduce((acc, arg, i) => acc.length && typeof acc[i - 1] === 'string' && typeof arg === 'string' ? [...acc.slice(0, -1), `${acc[i - 1]} ${arg}`] : [...acc, arg], [])
  // Print stacktrace in separate element rather than as part of JSON
  .reduce((acc, arg) => arg !== null && arg !== void 0 && arg.stack ? [...acc, arg === null || arg === void 0 ? void 0 : arg.stack, (0, _utils.serializeValue)(arg, ['stack'])] : [...acc, (0, _utils.serializeValue)(arg)], []);
};
...
const serializeMessage = ({
  ...
  if (isXHR) {
    ...
    lines.push(title);
    if (reqBody) {
      lines.push('Request: ' + (0, _utils.serializeValue)(reqBody));
    }
    if (resBody) {
      lines.push('Response: ' + (0, _utils.serializeValue)(resBody));
    }
    lines.push('Meta: ' + (0, _utils.serializeValue)(fetchMeta));
    if (err) {
...
/***/ "./src/plugins/OktaPluginDebugger/styles.ts":
/*!**************************************************!*\
  !*** ./src/plugins/OktaPluginDebugger/styles.ts ***!
  \**************************************************/
...
/***/ "./src/plugins/OktaPluginDebugger/ui.ts":
/*!**********************************************!*\
  !*** ./src/plugins/OktaPluginDebugger/ui.ts ***!
  \**********************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
exports.renderMessagesList = exports.renderMessageToList = exports.removeUI = exports.initUI = void 0;
var _styles = _interopRequireDefault(__webpack_require__(/*! ./styles */ "./src/plugins/OktaPluginDebugger/styles.ts"));
var _utils = __webpack_require__(/*! ./utils */ "./src/plugins/OktaPluginDebugger/utils.ts");
var _messages = __webpack_require__(/*! ./messages */ "./src/plugins/OktaPluginDebugger/messages.ts");
...
const addUI = cspNonce => {
  ui = {
    isHidden: true
  };
  ui.style = document.createElement('style');
  ui.style.textContent = _styles.default;
  if (cspNonce) {
  ...
  renderMessagesList((0, _messages.getMessages)());
  ...
  ui.switchBtn.onclick = () => {
    if (ui) {
      ...
      if (ui.isHidden) {
        var _ui$switchBtn, _ui$rootContainer;
        (_ui$switchBtn = ui.switchBtn) === null || _ui$switchBtn === void 0 ? void 0 : _ui$switchBtn.classList.remove('siw-debugger-selected');
        (_ui$rootContainer = ui.rootContainer) === null || _ui$rootContainer === void 0 ? void 0 : _ui$rootContainer.classList.add('siw-debugger-hidden');
        document.body.classList.remove('siw-debugger-no-scroll');
      } else {
        var _ui$switchBtn2, _ui$rootContainer2;
        (_ui$switchBtn2 = ui.switchBtn) === null || _ui$switchBtn2 === void 0 ? void 0 : _ui$switchBtn2.classList.add('siw-debugger-selected');
        (_ui$rootContainer2 = ui.rootContainer) === null || _ui$rootContainer2 === void 0 ? void 0 : _ui$rootContainer2.classList.remove('siw-debugger-hidden');
  ...
  ui.copyBtn.onclick = () => {
    copyToClipboard((0, _messages.serializeMessages)((0, _messages.getMessages)()));
  };
  ui.copyTextarea = document.createElement('textarea');
  ui.copyTextarea.className = 'siw-copy-textarea siw-debugger-hidden';
  [ui.copyTextarea, ui.rootContainer, ui.switchBtn, ui.copyBtn, ui.style].map(elem => {
    document.body.appendChild(elem);
  });
};
const removeUI = () => {
  var _ui, _ui2, _ui3, _ui4, _ui5;
  [(_ui = ui) === null || _ui === void 0 ? void 0 : _ui.style, (_ui2 = ui) === null || _ui2 === void 0 ? void 0 : _ui2.switchBtn, (_ui3 = ui) === null || _ui3 === void 0 ? void 0 : _ui3.copyBtn, (_ui4 = ui) === null || _ui4 === void 0 ? void 0 : _ui4.copyTextarea, (_ui5 = ui) === null || _ui5 === void 0 ? void 0 : _ui5.rootContainer].map(elem => {
    if (elem) {
...
const renderMessageToList = msg => {
  var _ui6;
  if ((_ui6 = ui) !== null && _ui6 !== void 0 && _ui6.list) {
    const item = renderMessage(msg);
    ui.list.appendChild(item);
  }
};
exports.renderMessageToList = renderMessageToList;
const renderMessagesList = messages => {
  var _ui7;
  if ((_ui7 = ui) !== null && _ui7 !== void 0 && _ui7.list) {
    ui.list.innerHTML = '';
...
const renderCollapsedContent = (data, name) => {
  if (data === undefined || data === null) {
    return [];
  }
  const content = document.createElement('pre');
  content.className = `siw-debugger-list-item-details`;
  content.innerText = (0, _utils.serializeValue)(data);
  let isHidden = true;
  if (isHidden) {
...
const renderFetchMessage = (fetchData, container) => {
  const {
    httpMethod,
    url,
    status,
...
const renderMessageContent = (args, container, firstArgIsHeader) => {
  const serializedArgs = (0, _messages.serializeArgs)(args);
  serializedArgs.forEach((arg, i) => {
    const content = document.createElement('pre');
    content.className = i === 0 && firstArgIsHeader ? 'siw-debugger-list-item-header' : 'siw-debugger-list-item-details';
...
/***/ "./src/plugins/OktaPluginDebugger/utils.ts":
/*!*************************************************!*\
  !*** ./src/plugins/OktaPluginDebugger/utils.ts ***!
  \*************************************************/
/***/ (function(__unused_webpack_module, exports) {
...
exports.toPlain = exports.serializeValue = exports.getCurrentTimeStamp = void 0;
/*!
 * Copyright (c) 2015-2016, Okta, Inc. and/or its affiliates. All rights reserved.
 * The Okta software accompanied by this notice is provided pursuant to the Apache License, Version 2.0 (the "License.")
 *
...
const serializeValue = (val, keysToExclude = []) => {
  if (typeof val === 'string') {
    return val;
  }
  try {
    const plain = typeof (val === null || val === void 0 ? void 0 : val.toJSON) === 'function' ? val.toJSON() : toPlain(val);
    for (const k of keysToExclude) {
      delete plain[k];
    }
    return JSON.stringify(plain, undefined, 2);
  } catch (e) {
    return `Can't serialize to JSON: ${e === null || e === void 0 ? void 0 : e.name} ${e === null || e === void 0 ? void 0 : e.message}`;
  }
};
exports.serializeValue = serializeValue;
const getSerializableKeysForCustomObject = val => {
  ...
  let obj = val;
  while (obj && ((_obj = obj) === null || _obj === void 0 ? void 0 : _obj.constructor) !== Object) {
    var _obj;
...
const isCustomObject = val => {
  return isObject(val) && (val === null || val === void 0 ? void 0 : val.constructor) !== Object;
};
...
//   ...
// }
const toPlain = (val, objectsMap = new Map(), path = '$') => {
  ...
  if (isCustomObject(val)) {
    return getSerializableKeysForCustomObject(val).filter(k => {
      let v;
      try {
        v = val[k];
      } catch (_e) {
    ...
    return Object.getOwnPropertyNames(val).reduce((acc, k) => ({
      ...acc,
      [k]: toPlain(val[k], objectsMap, `${path}.${k}`)
    }), {});
...
/*!*************************************************!*\
  !*** ./src/plugins/OktaPluginDebugger/index.ts ***!
  \*************************************************/
...
exports.isDebuggerEnabled = exports.initDebugger = exports.destroyDebugger = void 0;
__webpack_require__(/*! ../../../polyfill/debugger */ "./polyfill/debugger.js");
var _console = __webpack_require__(/*! ./console */ "./src/plugins/OktaPluginDebugger/console.ts");
var _fetch = __webpack_require__(/*! ./fetch */ "./src/plugins/OktaPluginDebugger/fetch.ts");
var _messages = __webpack_require__(/*! ./messages */ "./src/plugins/OktaPluginDebugger/messages.ts");
var _ui = __webpack_require__(/*! ./ui */ "./src/plugins/OktaPluginDebugger/ui.ts");
/*!
 * Copyright (c) 2015-2016, Okta, Inc. and/or its affiliates. All rights reserved.
 * The Okta software accompanied by this notice is provided pursuant to the Apache License, Version 2.0 (the "License.")
 *
...
let isEnabled = false;
const isDebuggerEnabled = () => isEnabled;
exports.isDebuggerEnabled = isDebuggerEnabled;
const initDebugger = options => {
  if (isEnabled) {
    return;
  }
  (0, _console.setOnNewMessage)(msg => {
    (0, _messages.addMessage)(msg);
    (0, _ui.renderMessageToList)(msg);
  });
  (0, _fetch.setOnNewFetch)(fetchData => {
    const msg = (0, _messages.fetchDataToMessage)(fetchData);
    (0, _messages.addMessage)(msg);
    (0, _ui.renderMessageToList)(msg);
  });
  (0, _console.addGlobalErrorListeners)();
  (0, _console.overrideConsole)();
  if ((options === null || options === void 0 ? void 0 : options.watchNetwork) !== false) {
    (0, _fetch.overrideFetch)();
  }
  (0, _ui.initUI)(options === null || options === void 0 ? void 0 : options.cspNonce);
  isEnabled = true;
};
exports.initDebugger = initDebugger;
const destroyDebugger = () => {
  if (!isEnabled) {
    return;
  }
  (0, _console.removeGlobalErrorListeners)();
  (0, _console.restoreConsole)();
  (0, _fetch.restoreFetch)();
  (0, _ui.removeUI)();
  (0, _console.setOnNewMessage)(undefined);
  (0, _fetch.setOnNewFetch)(undefined);
  (0, _messages.clearMessages)();
  isEnabled = false;
};
...
//# sourceMappingURL=okta-sign-in.debugger.js.map