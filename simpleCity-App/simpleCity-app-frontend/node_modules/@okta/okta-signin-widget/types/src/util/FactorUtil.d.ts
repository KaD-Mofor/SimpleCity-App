...
declare namespace fn {
    ...
    function getFactorLabel(provider: any, factorType: any): string;
    function getFactorDescription(provider: any, factorType: any): string;
    ...
    function getCardinalityText(enrolled: any, required: any, cardinality: any): string;
