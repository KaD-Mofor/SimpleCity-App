...
export declare function isInvalidActivationTokenError(error: any): error is StandardApiError;
export declare function formatInvalidRecoveryTokenError(error: StandardApiError): LegacyIdxError;
export declare function formatInvalidActivationTokenError(error: StandardApiError): LegacyIdxError;
